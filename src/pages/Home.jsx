        ...
        <div className="container mx-auto px-4 pt-5 flex flex-col">
          ...
          <div className="flex flex-col-reverse md:flex-row lg:justify-center">
            <div className="space-y-8 md:w-2/3 lg:w-1/3">
              <h1 className="judson mt-10">
                <b>Welcome to Amazing Angels, Where Compassion Meets Care</b>
              </h1>
              <div className="text-[#626262]">
                <p>
                  Our team of expirienced and highly-trained caregivers is
                  committed to ensuring the physical, emotional, and social well
                  being of each individual under our care.
                </p>
                <p>
                  We offer a range of personalized services tailored to meet the
                  unique needs of our clients.
                </p>
              </div>
              <div className="text-center">
                <button className="px-4 py-2 text-white bg-[#293241] rounded-lg">
                  Book Appointment
                </button>
              </div>
            </div>
